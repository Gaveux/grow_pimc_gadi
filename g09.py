...
#==========================================================================
# main function for running Gaussian09 jobs
#==========================================================================
...
#   util.Rmf('Test.FChk')
    ...
    coords.close()
    util.Run('Bohr2Ang < cdata_bohr > cdata_ang',s)
    #util.Run('cp cdata_bohr cdata_ang',s)
    # build comfile and run gradient calculation
    comfile = build_comfile(keyword_string,size,s)
    util.Run('g09 <' + comfile + ' > ' + logfile,s)
...
# util.Rmf('POT.temp')
  ...
  # 
  # commented out svd version
  # new input file iand version of bfinvert for svdtol and red rank 
  # B-matrix method
  # NB bfinvert now rewrites the POT file having reset the 
  # value of svdtol
  #input = 'cart_pot IN_SYSTEM IN_INTERP IN_ATOMPERMS POT auto'
  #output = os.popen('bfinvert ' + input,'r')
  ...
  #f.close()
  # increment and save file svd_opt file
  #n = str(s.NumData+1)
  #util.Run('cp svd_opt svd_opt' + n,s)
  #
  #  use old version of bfinvert
  #
  #output = os.popen('bfinvert_nosvdtol < freq.dat','r')
  util.Run('bfinvert_nosvdtol < freq.dat >> POT.temp',s)
  f = file('POT.temp','a')
  # add to POT file
...
def build_comfile(method_string,size,s):
  ...
  #print '   coordinates read in from file cdata_ang:'
  #print '   chosen geometry in Angstrom'
  #os.system("cat cdata_ang")
  #print ' '
