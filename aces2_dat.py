...
UNITS=BOHR,
'''
# technically, these aren't analytic frequencies, but it is more efficient to
# calculate them using aces2, rather than our code. So, we will treat them
# as analytic (that is, the complete 2nd deriv matrix can be obtained directly
# from the ab initio package)
# rmp2
methods['rmp2'] = '''
*ACES2(CALC=MBPT(2),
REF=RHF,
